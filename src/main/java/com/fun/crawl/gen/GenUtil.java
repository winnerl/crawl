package com.fun.crawl.gen;


import com.fun.crawl.gen.model.config.ColumnInfoConfig;
import com.fun.crawl.gen.model.config.TableInfoConfig;
...
public class GenUtil {
     ...
     * @param zip
     */
    public static void gen(BuildConfigDTO buildConfigDTO,TableInfoConfig tableConfig) {
        // 设置velocity资源加载器
        Properties prop = new Properties();
        prop.put("file.resource.loader.class", "org.apache.velocity.runtime.resource.loader.ClasspathResourceLoader");
        Velocity.init(prop);
    ...
    public static void generatorCodeToPackage(BuildConfigDTO buildConfigDTO, TableInfo tableInfo, List<ColumnInfo> columns) {
        ...
        // 生成代码
        gen(buildConfigDTO, tableConfig);
